...
export const postagemCreate = async(request, response) => {
    //Validação:
...
export const postagemAll = async (request, response) => {
  ...
  export const postagemGetById = async (request, response) => {
   ...
   export const postagemDelete = async (request, response) => {
 ...
 export const postagemAtualizar = async (request, response) => {
   ...
   export const postagemImages = async (request, response) => {
